        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-3 text-muted-foreground max-w-prose">
              RagAdvise plugs into the channels you already use—calls, email, calendar, storefront, payments—and keeps context flowing so every hub stays up to date. <a href="https://my.ragadvise.com/signup" className="font-medium text-primary underline-offset-4 hover:underline">Start free</a>.
            </p>

...
const newWaySolutions = [
  ...
  {
    icon: RefreshCw,
    title: "Improve Answers Over Time",
    desc: "AutoLearn records and transcribes every visitor chat. Review questions, improve answers, and it uses the updates next time.",
  },
];
  ...
  return (
    <>
      ...
      <div className="w-full bg-primary text-primary-foreground py-2 text-center text-sm font-medium">
        <p>First 30 minutes free with our AI voice assistant (Website Voice). <a href="https://my.ragadvise.com/demo/site-assistant?tab=site-assistant&subtab=settings" className="underline">Learn more</a></p>
      </div>
      <Header />

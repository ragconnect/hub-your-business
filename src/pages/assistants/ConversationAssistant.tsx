...
const ConversationPromptBox = () => {
  ...
  const saveAndRedirect = async (text: string) => {
    ...
    window.location.href = "https://my.ragadvise.com/demo/phone-settings?tab=phone-settings&subtab=purchase-number";
  };
  ...
  return (
    <>
      ...
      <div className="w-full bg-primary text-primary-foreground py-2 text-center text-sm font-medium">
        <p>First 30 minutes free with our AI receptionist (Phone Assistant). <a href="https://my.ragadvise.com/demo/phone-settings?tab=phone-settings&subtab=purchase-number" className="underline">Learn more</a></p>
      </div>
      <Header />
                ...
                <CardContent className="p-6 flex flex-col flex-1">
                  ...
                  <div className="flex flex-col gap-2">
                    <Button size="sm" className="w-full" asChild>
                      <a href="https://my.ragadvise.com/demo/phone-settings?tab=phone-settings&subtab=purchase-number" className="flex items-center justify-center gap-2">
                        <img src={googleLogo} alt="" className="w-5 h-5 bg-white rounded-full p-0.5" />
                        Sign up with Google & Get 30 Minutes Free
                      </a>
                    </Button>
                    <Button size="sm" variant="outline" className="w-full" asChild>
                      <a href="https://my.ragadvise.com/demo/phone-settings?tab=phone-settings&subtab=purchase-number">
